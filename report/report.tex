...
coefficient explains why: without HER it collapses toward zero while the
...
failure on a harder one. \emph{Why}: this shift is traceable to HER
sustaining healthy exploration (via SAC's entropy coefficient) where plain
sparse rewards let the policy converge prematurely on a failing behavior.
